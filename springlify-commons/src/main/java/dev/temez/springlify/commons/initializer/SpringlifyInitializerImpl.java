...
import dev.temez.springlify.commons.configuraiton.ConfigurationLoader;
import dev.temez.springlify.commons.configuraiton.ConfigurationLoaderImpl;
...
public class SpringlifyInitializerImpl implements SpringlifyInitializer {
  ...
  public ConfigurableApplicationContext initialize(@NotNull SpringlifyPlugin plugin) {
    SpringApplicationBuilder builder = new SpringApplicationBuilder(plugin.getApplicationClass())
