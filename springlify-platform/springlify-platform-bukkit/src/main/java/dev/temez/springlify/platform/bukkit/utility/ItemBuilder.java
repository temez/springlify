...
public abstract class ItemBuilder<B extends ItemBuilder<?>> {
  ...
  public @NotNull B enchantment(@NotNull Enchantment enchantment, int level) {
  ...
  public class SkullBuilder {
    ...
    public @NotNull SkullBuilder skin(@NotNull Skin skin) {
      this.skin = skin;
      return this;
    }

    public @NotNull SkullBuilder skin(@NotNull String texture, @NotNull String signature) {
      return skin(new Skin(texture, signature));
    }
